...
$sections[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'css' => '<?php if($value!="")echo ".header,.fixednav3{background-color: ".$value.";}"; ?>',
			'std' => ''
		),
		array(
			'type' => 'color',
...
$sections[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'std' => 'Copyright &copy; 2015 <a href="'.KING_ARKAHOST.'">ArkaHost.Com</a> - All rights reserved.'
		),
		array(
			'id' => 'footerMap',
			'type' => 'textarea',
...
$sections[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'sub_desc' => __('Format  "F d, Y H:i:s" for example "October 18, 2015 08:30:30"', 'arkahost'),
