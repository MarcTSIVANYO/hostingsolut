			 ...
			 vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						'param_name' => 'template',
						'admin_label' => true,
						'values' => Su_Tools::get_templates( 'team' )
					),
					array(
						'type' => 'textfield',
						'heading' => __( 'Amount', 'arkahost' ),
			...
			vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						'param_name' => 'template',
						'admin_label' => true,
						'values' => Su_Tools::get_templates( 'work' )
					),
					array(
						'type' => 'dropdown',
			...
			vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						'param_name' => 'template',
						'admin_label' => true,
						'values' => Su_Tools::get_templates( 'testimonial' )
					),	
					array(
						'type' => 'textfield',
						'heading' => __( 'Items Limit', 'arkahost' ),
			...
			vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						'param_name' => 'template',
						'admin_label' => true,
						'values' => Su_Tools::get_templates( 'pricing' )
					),
					array(
						'param_name' => 'icon',
						'type' 	=> 'icon',
			...
			vc_map( array(
				...
				'params' => array(
					array(
						...
						'param_name' => 'template',
						'admin_label' => true,
						'values' => Su_Tools::get_templates( 'flip' )
					),
					array(
						'type' => 'attach_image',
						'param_name' => 'img',
			...
			vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						'param_name' => 'template',
						'admin_label' => true,
						'values' => Su_Tools::get_templates( 'post' )
					),
					array(
						'type' => 'textfield',
						'heading' => __( 'Amount', 'arkahost' ),
